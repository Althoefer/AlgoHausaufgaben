...
public class Textsuche {
	...
	/**
	 * Diese Funktion gibt eine ArrayList mit Positionen zurueck, an denen das
	 * Pattern im Text gefunden wurde
	 *
	 * @param text
	 *            Text, der durchsucht wird
	 * @param pattern
	 *            Pattern, nach dem gesucht wird
